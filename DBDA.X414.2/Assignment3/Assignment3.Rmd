...
Two models will be trained, one using the whole Boston dataset and another excluding the features "indus" and "age" that were discovered to not to be important for the linear model. 
